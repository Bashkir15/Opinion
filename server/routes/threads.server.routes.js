...
router.get('/home', auth.justGetUser, threads.home);
...
router.get('/timeline/:userId', auth.justGetUser, threads.timeline);
router.get('/saved/:userId', auth.justGetUser, threads.savedThreads);
